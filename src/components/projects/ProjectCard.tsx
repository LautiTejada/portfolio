...
export default function ProjectCard({
	...
	return (
		<article className="group relative overflow-hidden rounded-xl border border-foreground/10 bg-foreground/[0.02] transition-all duration-300 hover:-translate-y-1 hover:border-foreground/20 hover:bg-foreground/[0.04] hover:shadow-lg hover:shadow-foreground/5 focus-within:ring-2 focus-within:ring-foreground/30">
			{/* Cover image */}
			{coverImage && (
				<div className="relative aspect-[2/1] overflow-hidden border-b border-foreground/[0.06]">
					<Image
						src={coverImage}
						alt={title}
						fill
